...
## أبرز القدرات (جاهزة وتعمل)
- **سوبر آب كامل**: طعام، بقالة، صيدليات، ورود، خدمات (14 مهنة بفرز
  «الأقرب إليك 📍»)، حجوزات طاولات ومواعيد واستشارات (📞/🏢)، تاكسي
  ‏+SOS، طرود بحماية OTP، ماركت بلايس C2C، وظائف+CV، **B2B تجار جملة**
  (حسابات merchant + حد أدنى للكميات).
- **لوحة تحكم 24 صفحة** تتحكم بكل التطبيقات لحظيًا: طلبات بخط زمني
  كامل + ETA متعلَّم، بث إشعارات FCM للجماهير، عناوين محظورة
  (مكافحة احتيال بإنفاذ من الخادم)، نقاط ولاء، جوائز مندوبين،
  محرك عمولات (شرائح/قواعد/ذروة)، رؤية فئات لكل مدينة، CSV عربي،
  مبدّل لغات بالهيدر يقلب RTL/LTR فورًا.
- **أمان**: قواعد Firestore مختبرة (16/16)، تحويلات حالة من الخادم
  فقط، Face ID قفل تطبيقات، سجلات أمنية، حد معدل الطلبات،
  SECURITY.md + Dependabot + CodeQL.
- **ذكاء**: ETA متعلَّم لكل متجر، إحصاءات سائق + مكافأة سرعة،
  مواقع زبائن متعلَّمة، Dyar Bot للدعم.
