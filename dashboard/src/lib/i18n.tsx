...
export const T: Dict = {
  ...
  liveTracking: { ar: 'التتبع الحي', he: 'מעקב חי', en: 'Live tracking' },
  liveMapHint:  { ar: 'خريطة المندوبين الحية — تتفعّل عند إدخال مفتاح Google Maps', he: 'מפת שליחים חיה — תופעל עם מפתח Google Maps', en: 'Live drivers map — enables with Google Maps key' },
  onlineDrivers:{ ar: 'مندوبون متصلون', he: 'שליחים מחוברים', en: 'Online drivers' },
  learnByType:  { ar: 'تعلّم التوقيت حسب النوع', he: 'למידת זמנים לפי סוג', en: 'Learned timing by type' },
  identity:     { ar: 'الهوية الرقمية', he: 'זהות דיגיטלית', en: 'Digital identity' },
  stories:      { ar: 'الستوري', he: 'סטוריז', en: 'Stories' },
  companies:    { ar: 'الشركات (وجبات)', he: 'חברות (ארוחות)', en: 'Companies (meals)' },
  rfqs:         { ar: 'عروض الجملة B2B', he: 'הצעות סיטונאות B2B', en: 'B2B quotes (RFQ)' },
  rfqsOpen:     { ar: 'طلبات مفتوحة', he: 'בקשות פתוחות', en: 'Open requests' },
  rfqsQuoted:   { ar: 'بانتظار رد', he: 'ממתינות לתשובה', en: 'Awaiting reply' },
  rfqsVolume:   { ar: 'حجم الصفقات المقبولة', he: 'נפח עסקאות', en: 'Accepted volume' },
  rfqsCommission:{ ar: 'عمولة ديار (محفوظة)', he: 'עמלת דיאר', en: 'Dyar commission' },
  rfqProduct:   { ar: 'المنتج', he: 'מוצר', en: 'Product' },
  rfqQty:       { ar: 'الكمية', he: 'כמות', en: 'Qty' },
  unitPrice:    { ar: 'سعر الوحدة', he: 'מחיר ליחידה', en: 'Unit price' },
  rfqCommission:{ ar: 'العمولة', he: 'עמלה', en: 'Commission' },
  rfqStatus_open:    { ar: 'مفتوح', he: 'פתוח', en: 'Open' },
  rfqStatus_quoted:  { ar: 'بعرض سعر', he: 'הוצע מחיר', en: 'Quoted' },
  ...
  period:       { ar: 'الدورة', he: 'מחזור', en: 'Period' },
  daily:        { ar: 'يومي', he: 'יומי', en: 'Daily' },
  monthly:      { ar: 'شهري', he: 'חודשי', en: 'Monthly' },
  addStory:     { ar: 'إضافة ستوري', he: 'הוספת סטורי', en: 'Add story' },
  storyHint:    { ar: 'ارفع صورًا و/أو فيديو — تظهر بنمط إنستجرام في الرئيسية', he: 'העלה תמונות/וידאו — מוצג כמו סטורי', en: 'Upload images and/or video — shown Instagram-style on Home' },
