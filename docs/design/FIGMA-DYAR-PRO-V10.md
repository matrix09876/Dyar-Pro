...
## صفحة 06 · Super-App — C1–C8 (شريحة لكل فئة)
| الإطار | Node | وصلات |
|---|---|---|
| C1 قالب هبوط الفئة (🍔) | `160:2` | spec→U2/U3/U15 |
| C1a 👗 ملابس · C1b 📱 إلكترونيات · C1c 🏪 B2B | `160:121` `160:240` `160:359` | — |
| C2a أظافر قريب مني — قائمة | `163:2` | بطاقة→C2b |
| C2b بروفايل الصالون (₪80/₪60/₪150) | `163:70` | CTA→C2c |
| C2c موعدك محجوز ✅ | `163:136` | — |
| C3 استشارة ⚖️ (📞₪150/🏢₪250) | `166:2` | booking_sheet mode |
| C4a بوتيك + C4b شيت مقاسات/ألوان | `167:2` `167:87` | متبادلة |
| C5 إلكترونيات (مواصفات+ضمان🛡️) | `168:2` | — |
| C6 B2B جملة (minQty+ائتمان+RFQ) | `166:67` | عقد merchant/minQty |
| C7 مكتبة المهن الـ14 | `168:70` | — |
| C8 مكتبة MenuBrand ×5 (قيم `menu_templates.dart` حرفيًا) | `169:2` | — |

## ✅ بوابة QA الختامية (12/06/2026)
فحص آلي شامل عبر الصفحات العشر:
**196 إطارًا · 156 وصلة ON_CLICK→NAVIGATE · صفر شرائح CTA-spec مقصوصة
· صفر مشاكل** — الملف مسلَّم «جاهز للعمل مع كل الإضافات»:
User ‏19 · Driver ‏13 · Partner ‏8 · Dashboard ‏25 (A1–A24) · Web ‏2 ·
Super-App ‏20 · Ultra-Merge ‏108 (07/08/09) · Scorecard.
