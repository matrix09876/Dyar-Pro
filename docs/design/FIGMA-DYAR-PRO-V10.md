...
### اللوحة A17–A24 (إكمال كل الأقسام + الميزات الجديدة)
| الإطار | Node | CTA-spec | ملاحظات |
|---|---|---|---|
| A17-Support | `149:2` | `149:200` | 4 عدّادات حية + جدول التذاكر |
| A18-Cities | `149:203` | `149:407` | مدن الجليل + **حوار الفئة الجماعي** (writeBatch) |
| A19-Notes | `150:2` | `150:194` | كانبان todo/doing/done |
| A20-Training | `150:197` | `150:404` | FAQ سائق/تاجر/زبون |
| A21-Logs | `152:2` | `152:229` | 9 تبويبات — security 🛡️ مميز |
| A22-Team | `152:232` | `152:458` | صلاحيات staffCan تشمل ✓ broadcast |
| A23-Broadcast | `154:2` | `154:218` | **جديد** — ملحن البث + CTA متدرّج 54px + سجل |
| A24-Blocked-Addresses | `156:2` | `156:204` | **جديد** — بانر الإنفاذ الأحمر + CRUD + حوار |

- A23/A24 تحملان **الهيدر العلوي** (مرحبًا + مبدّل العربية/עברית/English
  ‏+ 🌙 + خروج) المطابق لـ`Layout.tsx`، وقائمتاهما الجانبيتان بـ22 بندًا
  (يشملان 📣 و🚫). شريحة توثيق الهيدر على A2: ‏`156:207`.
- وصلات نقر بكل إطار جديد: نظرة عامة→`16:39` والطلبات→`17:2`.
